Need to Hot swap the swap file size to increase or decrease the swap size of the swap file? Set-swap will hot-swap the swap file to increase or decrease the swap size of the swap file.
